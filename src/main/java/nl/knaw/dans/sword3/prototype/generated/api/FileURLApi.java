...
@Api(value = "File-URL", description = "the File-URL API")
public interface FileURLApi {

    Logger log = LoggerFactory.getLogger(FileURLApi.class);
    ...
    @ApiOperation(value = "Delete an individual File", nickname = "deleteFile", notes = "", tags={  })
    @ApiResponses(value = {
        @ApiResponse(code = 204, message = "Binary File Deleted"),
    ...
    default ResponseEntity<Void> deleteFile(@ApiParam(value = "" ) @RequestHeader(value="Authorization", required=false) String authorization
...
,@ApiParam(value = "" ) @RequestHeader(value="On-Behalf-Of", required=false) String onBehalfOf
        ...
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            ...
            log.warn("ObjectMapper or HttpServletRequest not configured in default FileURLApi interface so no example is generated");
        }
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    }


    @ApiOperation(value = "Retrieve an individual File", nickname = "getMetadataEko", notes = "", response = Resource.class, tags={  })
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Binary File", response = Resource.class),
        @ApiResponse(code = 400, message = "**400 (BadRequest)** - The server could not understand your request.  Either your headers or content body are wrong or malformed."),
        @ApiResponse(code = 401, message = "**403 (Forbidden)** - You are not authorised to access this resource"),
        @ApiResponse(code = 403, message = "**401 (Unauthorized)** - You have not provided authentication information, please do so"),
        @ApiResponse(code = 404, message = "**404 (Not Found)** - There is no resource available at the URL you requested"),
    ...
    default ResponseEntity<Resource> getMetadataEko(@ApiParam(value = "" ) @RequestHeader(value="Authorization", required=false) String authorization
,@ApiParam(value = "" ) @RequestHeader(value="On-Behalf-Of", required=false) String onBehalfOf
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
    ...
    @ApiOperation(value = "Replace an individual File", nickname = "replaceFile", notes = "", tags={  })
    @ApiResponses(value = {
        @ApiResponse(code = 204, message = "Binary File replaced, no response body"),
        @ApiResponse(code = 400, message = "**400 (BadRequest)** - The server could not understand your request.  Either your headers or content body are wrong or malformed."),
        @ApiResponse(code = 401, message = "**403 (Forbidden)** - You are not authorised to access this resource"),
        @ApiResponse(code = 403, message = "**401 (Unauthorized)** - You have not provided authentication information, please do so"),
        @ApiResponse(code = 404, message = "**404 (Not Found)** - There is no resource available at the URL you requested"),
    ...
    default ResponseEntity<Void> replaceFile(@ApiParam(value = "Content to replace the File.  This can be one of: By-Reference, Binary File, Empty Body"  )  @Valid @RequestBody Object body
