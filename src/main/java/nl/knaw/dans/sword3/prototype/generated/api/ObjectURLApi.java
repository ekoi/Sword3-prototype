...
@Api(value = "Object-URL", description = "the Object-URL API")
public interface ObjectURLApi {

    Logger log = LoggerFactory.getLogger(ObjectURLApi.class);
    ...
    @ApiOperation(value = "Append data to an Object", nickname = "appendObject", notes = "", response = Object.class, tags={  })
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Content appended, responds with Status Document", response = Object.class),
        @ApiResponse(code = 202, message = "Content accepted for append, responds with Status Document", response = Object.class),
    ...
    @RequestMapping(value = "/Object-URL",
        produces = { "application/json" },
        consumes = { "application/json", "*/*" },
        method = RequestMethod.POST)
    default ResponseEntity<Object> appendObject(@ApiParam(value = "Content to be appended to the Object.  This can be one of: Metadata, By-Reference, Metadata+By-Reference, Binary File, Packaged Content, Empty Body"  )  @Valid @RequestBody Object body
...
,@ApiParam(value = "" ) @RequestHeader(value="In-Progress", required=false) String inProgress
...
,@ApiParam(value = "" ) @RequestHeader(value="Metadata-Format", required=false) String metadataFormat
        ...
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            ...
            log.warn("ObjectMapper or HttpServletRequest not configured in default ObjectURLApi interface so no example is generated");
        }
    ...
    @ApiOperation(value = "Delete the Object", nickname = "deleteObject", notes = "", tags={  })
    @ApiResponses(value = {
    ...
    default ResponseEntity<Void> deleteObject(@ApiParam(value = "" ) @RequestHeader(value="Authorization", required=false) String authorization
,@ApiParam(value = "" ) @RequestHeader(value="If-Match", required=false) String ifMatch
,@ApiParam(value = "" ) @RequestHeader(value="On-Behalf-Of", required=false) String onBehalfOf
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
    ...
    @ApiOperation(value = "Retrieve the Status information for the Object", nickname = "getObject", notes = "", response = Object.class, tags={  })
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Status Document", response = Object.class),
        @ApiResponse(code = 400, message = "**400 (BadRequest)** - The server could not understand your request.  Either your headers or content body are wrong or malformed."),
        @ApiResponse(code = 401, message = "**403 (Forbidden)** - You are not authorised to access this resource"),
        @ApiResponse(code = 403, message = "**401 (Unauthorized)** - You have not provided authentication information, please do so"),
        @ApiResponse(code = 404, message = "**404 (Not Found)** - There is no resource available at the URL you requested"),
    ...
    default ResponseEntity<Object> getObject(@ApiParam(value = "" ) @RequestHeader(value="Authorization", required=false) String authorization
,@ApiParam(value = "" ) @RequestHeader(value="On-Behalf-Of", required=false) String onBehalfOf
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
    ...
    @ApiOperation(value = "Replace the Object", nickname = "replaceObject", notes = "", response = Object.class, tags={  })
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Replace carried out, responds with Status Document", response = Object.class),
        @ApiResponse(code = 202, message = "Replace accepted for action, responds with Status Document", response = Object.class),
        @ApiResponse(code = 400, message = "**400 (BadRequest)** - The server could not understand your request.  Either your headers or content body are wrong or malformed."),
        @ApiResponse(code = 401, message = "**403 (Forbidden)** - You are not authorised to access this resource"),
        @ApiResponse(code = 403, message = "**401 (Unauthorized)** - You have not provided authentication information, please do so"),
        @ApiResponse(code = 404, message = "**404 (Not Found)** - There is no resource available at the URL you requested"),
    ...
    default ResponseEntity<Object> replaceObject(@ApiParam(value = "Content to replace the Object.  This can be one of: Metadata, By-Reference, Metadata+By-Reference, Binary File, Packaged Content, Empty Body"  )  @Valid @RequestBody Object body
,@ApiParam(value = "" ) @RequestHeader(value="Authorization", required=false) String authorization
,@ApiParam(value = "" ) @RequestHeader(value="Content-Disposition", required=false) String contentDisposition
,@ApiParam(value = "" ) @RequestHeader(value="Content-Length", required=false) Integer contentLength
,@ApiParam(value = "" ) @RequestHeader(value="Content-Type", required=false) String contentType
