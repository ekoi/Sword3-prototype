...
@Api(value = "Service-URL", description = "the Service-URL API")
public interface ServiceURLApi {

    Logger log = LoggerFactory.getLogger(ServiceURLApi.class);
    ...
    @ApiOperation(value = "Make a new Object", nickname = "doDeposit", notes = "", response = Object.class, tags={  })
    @ApiResponses(value = {
        @ApiResponse(code = 201, message = "Resource created, responds with Status Document", response = Object.class),
        @ApiResponse(code = 202, message = "Resource accepted for processing, responds with Status Document", response = Object.class),
    ...
    default ResponseEntity<Object> doDeposit(@ApiParam(value = "Content used to create new Object.  This can be one of: Metadata, By-Reference, Metadata+By-Reference, Binary File, Packaged Content, Empty Body"  )  @Valid @RequestBody Object body
...
,@ApiParam(value = "" ) @RequestHeader(value="Slug", required=false) String slug
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            ...
            log.warn("ObjectMapper or HttpServletRequest not configured in default ServiceURLApi interface so no example is generated");
        }
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    }


    @ApiOperation(value = "Retrieve the Service Document", nickname = "getService", notes = "", response = Object.class, tags={  })
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Service Document", response = Object.class),
        @ApiResponse(code = 401, message = "**403 (Forbidden)** - You are not authorised to access this resource"),
        @ApiResponse(code = 403, message = "**401 (Unauthorized)** - You have not provided authentication information, please do so"),
        @ApiResponse(code = 404, message = "**404 (Not Found)** - There is no resource available at the URL you requested"),
        @ApiResponse(code = 301, message = "**301 (Moved Permanently)** - The URL you requested has changed, re-send this request and all future requests to the new URL"),
    ...
    default ResponseEntity<Object> getService(@ApiParam(value = "" ) @RequestHeader(value="Authorization", required=false) String authorization
,@ApiParam(value = "" ) @RequestHeader(value="On-Behalf-Of", required=false) String onBehalfOf
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
