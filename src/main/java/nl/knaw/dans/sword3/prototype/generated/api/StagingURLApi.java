...
@Api(value = "Staging-URL", description = "the Staging-URL API")
public interface StagingURLApi {

    Logger log = LoggerFactory.getLogger(StagingURLApi.class);
    ...
    @ApiOperation(value = "Create a Temporary-URL for Segmented File Upload", nickname = "createTemporary", notes = "", tags={  })
    @ApiResponses(value = {
        @ApiResponse(code = 201, message = "Temporary-URL created"),
    ...
    @RequestMapping(value = "/Staging-URL",
        method = RequestMethod.POST)
    default ResponseEntity<Void> createTemporary(@ApiParam(value = "" ) @RequestHeader(value="Authorization", required=false) String authorization
...
,@ApiParam(value = "" ) @RequestHeader(value="On-Behalf-Of", required=false) String onBehalfOf
        ...
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            ...
            log.warn("ObjectMapper or HttpServletRequest not configured in default StagingURLApi interface so no example is generated");
        }
