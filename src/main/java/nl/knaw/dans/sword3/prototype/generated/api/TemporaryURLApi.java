...
@Api(value = "Temporary-URL", description = "the Temporary-URL API")
public interface TemporaryURLApi {

    Logger log = LoggerFactory.getLogger(TemporaryURLApi.class);
    ...
    @ApiOperation(value = "Abort a Segmented File Upload", nickname = "abortSegmentedFile", notes = "", tags={  })
    @ApiResponses(value = {
        @ApiResponse(code = 204, message = "Temporary File Deleted"),
    ...
    @RequestMapping(value = "/Temporary-URL",
        method = RequestMethod.DELETE)
    default ResponseEntity<Void> abortSegmentedFile(@ApiParam(value = "" ) @RequestHeader(value="Authorization", required=false) String authorization
,@ApiParam(value = "" ) @RequestHeader(value="On-Behalf-Of", required=false) String onBehalfOf
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default TemporaryURLApi interface so no example is generated");
        }
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    }


    @ApiOperation(value = "Retrieve Information on a Segmented File Upload", nickname = "getTemporary", notes = "", response = Object.class, tags={  })
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Segmented File Upload Document", response = Object.class),
        @ApiResponse(code = 400, message = "**400 (BadRequest)** - The server could not understand your request.  Either your headers or content body are wrong or malformed."),
        @ApiResponse(code = 401, message = "**403 (Forbidden)** - You are not authorised to access this resource"),
        @ApiResponse(code = 403, message = "**401 (Unauthorized)** - You have not provided authentication information, please do so"),
        @ApiResponse(code = 404, message = "**404 (Not Found)** - There is no resource available at the URL you requested"),
    ...
    default ResponseEntity<Object> getTemporary(@ApiParam(value = "" ) @RequestHeader(value="Authorization", required=false) String authorization
,@ApiParam(value = "" ) @RequestHeader(value="On-Behalf-Of", required=false) String onBehalfOf
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
    ...
    @ApiOperation(value = "Upload a File Segment", nickname = "uploadFileSegment", notes = "", tags={  })
    @ApiResponses(value = {
        @ApiResponse(code = 204, message = "Segment Received"),
        @ApiResponse(code = 400, message = "**400 (BadRequest)** - The server could not understand your request.  Either your headers or content body are wrong or malformed."),
        @ApiResponse(code = 401, message = "**403 (Forbidden)** - You are not authorised to access this resource"),
        @ApiResponse(code = 403, message = "**401 (Unauthorized)** - You have not provided authentication information, please do so"),
        @ApiResponse(code = 404, message = "**404 (Not Found)** - There is no resource available at the URL you requested"),
    ...
    default ResponseEntity<Void> uploadFileSegment(@ApiParam(value = "Segment to be added to the Resource."  )  @Valid @RequestBody Object body
