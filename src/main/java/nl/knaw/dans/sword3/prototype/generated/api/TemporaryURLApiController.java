...
@Controller
public class TemporaryURLApiController implements TemporaryURLApi {
    ...
    public TemporaryURLApiController(ObjectMapper objectMapper, HttpServletRequest request) {
